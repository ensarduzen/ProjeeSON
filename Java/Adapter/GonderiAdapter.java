...
import com.example.yeniprojem.Cerceve.GonderiDetayiFragment;
...
import com.example.yeniprojem.YorumlarActivity;
...
public class GonderiAdapter extends RecyclerView.Adapter<GonderiAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int i) {
        ...
        //Begeniler textine tıklandığında
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            profil_resmi = itemView.findViewById(R.id.profil_resmi_Ogesi);
        ...
        begeniVeriTabaniYolu.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child(mevcutKullanici.getUid()).exists()){
                    ...
                    imageView.setImageResource(R.drawable.ic_begeni2);
        ...
        kaydetmeYolu.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child(gonderiId).exists()){
                    ...
                    imageView.setImageResource(R.drawable.ic_kaydet_siyah2);
