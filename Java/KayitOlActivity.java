...
public class KayitOlActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_KayitOl=findViewById(R.id.KayitOl_Activity);
        ...
        btn_KayitOl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(str_kullaniciAdi ) || TextUtils.isEmpty(str_Ad)|| TextUtils.isEmpty(str_Email)|| TextUtils.isEmpty(str_Sifre)){
                    ...
                    Toast.makeText(KayitOlActivity.this, "Lütfen bütün alanları doldurunuz.", Toast.LENGTH_SHORT).show();
                }
                else if (str_Sifre.length()<6){
                    Toast.makeText(KayitOlActivity.this, "Şifreniz minimum 6 karakter olmalı.", Toast.LENGTH_SHORT).show();
                }
                else {
                    //Yeni kullanici kaydetme kodlarini çağır
    ...
    private void kaydet(final String kullaniciadi, final String ad, String email, String sifre){
        ...
        //Yeni kullanici kaydetme kodlari
                ...
                .addOnCompleteListener(KayitOlActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            hashMap.put("ad",ad);
                            hashMap.put("bio","");
                            hashMap.put("resimurl","https://firebasestorage.googleapis.com/v0/b/yeniprojem-f5c6c.appspot.com/o/default_profile.png?alt=media&token=e77e61bd-a283-45a4-8c83-712574a40713");
                            ...
                            yol.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if (task.isSuccessful()){
                                        ...
                                        Intent intent = new Intent(KayitOlActivity.this,AnaSayfaActivity.class);
                            ...
                            pd.dismiss();
                            Toast.makeText(KayitOlActivity.this, "Bu e-mail veya şifre ile kayıt başarısız..", Toast.LENGTH_LONG).show();
                        }
